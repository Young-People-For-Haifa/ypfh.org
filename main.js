...
const texts = {
    en: {
        ...
        communityButton: "Join Our Community"
    },
    ru: {
        navHome: "Главная",
        navProjects: "Проекты",
        ...
        communityButton: "Вступайте в сообщество"
    },
    he: {
        navHome: "בית",
        ...
        communityButton: "הצטרפו לקהילה שלנו"
    }
};
...
function setLanguage(lang) {
    ...
    document.querySelector('.community-button').innerText = language.communityButton;
